...
for tool in tcpdump strace gdb nmap jq curl openssl socat dig mtr lsof ip ss bridge tc tshark; do
...
echo "Installed tcpdump, strace, gdb, nmap, jq, curl, openssl, socat, dig, mtr, lsof, ip, ss, bridge, tc, and tshark in $bin_dir"
