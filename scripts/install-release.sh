...
for tool in tcpdump strace gdb nmap jq curl openssl socat dig mtr; do
...
echo "Installed tcpdump, strace, gdb, nmap, jq, curl, openssl, socat, dig, and mtr in $bin_dir"
