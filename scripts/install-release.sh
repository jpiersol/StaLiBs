...
for tool in tcpdump strace gdb nmap jq curl openssl socat dig mtr lsof; do
...
echo "Installed tcpdump, strace, gdb, nmap, jq, curl, openssl, socat, dig, mtr, and lsof in $bin_dir"
