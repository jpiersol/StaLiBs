...
.PHONY: build build-tcpdump build-strace build-gdb build-nmap build-jq build-curl build-openssl build-socat build-dig build-mtr build-lsof build-iproute2 build-tshark build-ripgrep package verify clean update-upstream

build: build-tcpdump build-strace build-gdb build-nmap build-jq build-curl build-openssl build-socat build-dig build-mtr build-lsof build-iproute2 build-tshark build-ripgrep
