...
for tool in tcpdump strace gdb nmap jq curl openssl socat dig mtr lsof ip ss bridge tc tshark rg; do
...
echo "Installed tcpdump, strace, gdb, nmap, jq, curl, openssl, socat, dig, mtr, lsof, ip, ss, bridge, tc, tshark, and rg in $bin_dir"
