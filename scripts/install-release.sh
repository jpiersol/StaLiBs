...
for tool in tcpdump strace gdb nmap jq curl openssl socat dig mtr lsof ip ss bridge tc; do
...
echo "Installed tcpdump, strace, gdb, nmap, jq, curl, openssl, socat, dig, mtr, lsof, ip, ss, bridge, and tc in $bin_dir"
